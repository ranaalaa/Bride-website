...
<<<<<<< HEAD
ActiveRecord::Schema.define(version: 20150320141340) do

  create_table "packagezs", force: true do |t|
    t.string   "name"
    t.string   "price"
    t.text     "description"
    t.integer  "post_id"
  ...
  add_index "packagezs", ["post_id"], name: "index_packagezs_on_post_id"
  ...
  create_table "spasamples", force: true do |t|
    t.text     "info"
    t.integer  "post_id"
    t.datetime "created_at"
    t.datetime "updated_at"
...
<<<<<<< HEAD
  add_index "spasamples", ["post_id"], name: "index_spasamples_on_post_id"
=======
