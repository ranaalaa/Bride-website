...
class DressesControllerTest < ActionController::TestCase
  ...
  test "should create dress" do
    assert_difference('Dress.count') do
      post :create, dress: { address: @dress.address, email: @dress.email, mobile: @dress.mobile, name: @dress.name }
    end
  ...
  test "should update dress" do
    patch :update, id: @dress, dress: { address: @dress.address, email: @dress.email, mobile: @dress.mobile, name: @dress.name }
    assert_redirected_to dress_path(assigns(:dress))
  end
